            ...
            <section className="hero-section">
                ...
                <Container className="hero-container text-center">
                    ...
                    <div className="hero-buttons d-flex justify-content-center gap-3">
                        <Button className="btn-primary-custom" onClick={() => navigate('/facilities')}>
                            시설 예약하러 가기
                                ...
                                <Col xs={12} lg={4} key={facility.facIdx}>
                                    <Card className="facility-preview-card border-0 h-100 shadow-sm">
                                        <Card.Body className="d-flex flex-column p-4">
                                            ...
                                            <Button variant="primary" className="w-100 py-2 border-0 btn-card" onClick={() => navigate('/reserve?facilityId=' + facility.facIdx)}>
                                                지금 예약 신청하기
                                            </Button>
                                        </Card.Body>
                                    </Card>
